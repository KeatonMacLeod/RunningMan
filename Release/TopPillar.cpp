...
{
	bool gameOver = false;
	//if (character.currentPosition.x + character.rect.w + CHARACTER_WIDTH_OFFSET + PILLAR_WIDTH_OFFSET >= currentPosition.x - rect.w / 2 && character.currentPosition.x - CHARACTER_WIDTH_OFFSET + PILLAR_WIDTH_OFFSET <= currentPosition.x + rect.w / 2 && character.currentPosition.y <= currentPosition.y + currentPosition.h)
